...
prompt = 'manga style, black and white, screen tones, g-pen, 1girl playing guitar on bed, bedroom atmosphere'
...
workflow = {
    ...
    '6': {'inputs': {'seed': 42, 'steps': 20, 'cfg': 1.0, 'sampler_name': 'euler', 'scheduler': 'simple', 'denoise': 0.6, 'model': ['1', 0], 'positive': ['2', 0], 'negative': ['2', 0], 'latent_image': ['3', 0]}, 'class_type': 'KSampler'},
...
print('Submitting FLUX Fallback job...')
...
if resp.status_code == 200:
    ...
    for i in range(30):
        ...
        if status == 'COMPLETED':
            ...
            output_path = r'C:\Users\takut\.gemini\antigravity\brain\b791680f-5a46-4d8c-aefc-c4b40c50a6e6\flux_fallback_manga.png'
