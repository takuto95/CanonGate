...
workflow = {
    ...
    '7': {'inputs': {'image': 'canonical_sketch.png'}, 'class_type': 'LoadImage'}, # Use standard LoadImage
...
# Add images mapping for special RunPod handlers
payload = {
    'input': {
        'workflow': workflow,
...
print('Submitting job with image mapping...')
...
if resp.status_code == 200:
    ...
    for i in range(40):
        ...
        if status == 'COMPLETED':
            ...
            output_path = r'C:\Users\takut\.gemini\antigravity\brain\b791680f-5a46-4d8c-aefc-c4b40c50a6e6\real_gpu_manga_result_v2.png'
